...
export const criarAtivoSchema = z.object({
  ...
  // Aporte SAIU daqui (doc 02 §19, decisão Luís 20/09): no ativo declara-se só a
  // estrutura jurídica dona; valor aportado e taxa de retorno são assunto da
  // estrutura e serão discutidos adiante.
